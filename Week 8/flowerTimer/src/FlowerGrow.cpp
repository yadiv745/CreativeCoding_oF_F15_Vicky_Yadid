...
leafBornLength = 65;
leafBornWidth = 70;
leafBornColor =ofColor(229,131,171,90);


//leaf is growing
leafGrowingLength = 40;
leafGrowingWidth = 15;
leafGrowingColor = ofColor(237,39,119,60);

//leaf grew
leafGrowLength = 55;
leafGrowWidth = 20;
leafGrowColor = ofColor(237,39,119,80);

stemLength = 3;
stemWidth = 3;
stemColor = ofColor(229,131,171,80);
...
//--------------------------------------------------------------
void FlowerGrow::update(){
    
}

//--------------------------------------------------------------
void FlowerGrow::draw(){
